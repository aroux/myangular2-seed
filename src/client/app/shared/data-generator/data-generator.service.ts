...
export class DataGeneratorService {
  ...
  private firstNames:string[] = ["Sophie", "Isabelle", "Emily", "Olivia", "Lily", "Chloe", "Isabella",
    "Amelia", "Jessica", "Sophia", "Ava", "Charlotte", "Mia", "Lucy", "Grace", "Ruby",
    "Ella", "Evie", "Freya", "Isla", "Poppy", "Daisy", "Layla"];

  private lastNames:string[] = ["Beckham", "Black", "Braxton", "Brennan", "Brock", "Bryson", "Cadwell",
  ...
  private createRandomPhoneNumber():string {
    let result = '+';
    for (let i = 0; i < 12; i++) {
  ...
  createRowData(count:number):Person[] {
    let rowData:Person[] = [];

    for (let i = 0; i < count; i++) {
      let countryData = this.countries[i % this.countries.length];
      rowData.push({
        id: i,
